...
function setup() {
  ...
  //giving the initial value to score
   score = 0  
...
function draw() {
  ...
  //spawining random colour balloons
  ...
  //destrying arrow and balloon when arrow is hitting any balloon
